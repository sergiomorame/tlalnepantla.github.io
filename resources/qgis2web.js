...
map.getView().fit([-11052284.893670, 2213385.191958, -11026746.729155, 2225545.148383], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Tlalnepantla</h2>';
        return titleElement;
    })(),
